...
print()
print(
    f"  {'ω':>4}  {'type':>10}  {'sup = 2^(-1/(ω-1))':>20}  {'numerical sup':>14}  {'gap':>10}"
)
print("  " + "-" * 65)
...
for omega, (bound, num_sup) in balanced_sups.items():
    ...
    print(
        f"  {omega:>4}  {omega_balanced_types[omega]:>10}  {formula_val:>20.10f}  {num_sup:>14}  {formula_val - float(num_sup):>10.6f}"
    )
...
rows = [
    (
        ...
        "1/√2 = 2^{-1/2}",
        "PROVED",
        "ρ² < 1/2 (F16); sharpness via twin primes",
    ),
