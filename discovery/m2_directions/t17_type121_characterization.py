...
print(
    f"Type (1,2,1): {passed + failed} triples checked, {passed} passed, {failed} failed"
)
...
print()
print(
    "  DEGENERACY CONDITION: shortest vector is degenerate iff r < max(p,q), i.e., a > r."
)
print()
